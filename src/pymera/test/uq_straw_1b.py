...
sims.set_parameter(name='tip-displacement-z', mean=0.100, stdev=0.010)
sims.set_parameter(name='fmr:geom:block:length', to=1.000) #x
sims.set_parameter('fmr:geom:block:width',  0.050)# y
sims.set_parameter('fmr:geom:block:height', 0.050)# z
