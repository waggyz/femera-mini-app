...
TEST(FmrPerfMeter, Startup) {
  ...
  EXPECT_FLOAT_EQ(perf.get_busy_s (), fmr::perf::Float(0));
  EXPECT_GT(perf.get_idle_s (), fmr::perf::Float(0));
  EXPECT_GT(perf.get_work_s (), fmr::perf::Float(0));
