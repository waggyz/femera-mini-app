...
for P in $PLIST; do
  ...
  1)
    ...
    case $CPUMODEL in
    6148)    MINPART=40;  MINSIZE_MD=480819; ELEM_PER_PART=20000; DOF_PER_PART=10000; ;;
    6148b)   MINPART=80;  MINSIZE_MD=480819; ELEM_PER_PART=20000; DOF_PER_PART=10000; ;;
    E5-2640) ;;
    E5-2650) ;;
    E5-2670) ;;
    esac
  ...
  2)
    ...
    case $CPUMODEL in
    #6148)    MINPART=240; MINSIZE_MD=679635; ELEM_PER_PART=8900; DOF_PER_PART=35767; ;;
    6148)    MINPART=240; MINSIZE_MD=679635; ELEM_PER_PART=4300; DOF_PER_PART=17200; ;;
    6148b)   MINPART=160; MINSIZE_MD=679635; ELEM_PER_PART=7800; DOF_PER_PART=31296; ;;
    E5-2640) ;;
    E5-2650) ;;
    E5-2670) MINPART=160; MINSIZE_MD=234459; ELEM_PER_PART=1000;  DOF_PER_PART=4000; ;;
    esac
    ;;
  3)
    ...
    case $CPUMODEL in
    6148)    MINPART=xxx; MINSIZE_MD=xxx; ELEM_PER_PART=100; DOF_PER_PART=1400 ;;
    6148b)   MINPART=xxx; MINSIZE_MD=xxx; ELEM_PER_PART=100; DOF_PER_PART=1400  ;;
    E5-2640) ;;
    E5-2650) ;;
    E5-2670) MINPART=144; MINSIZE_MD=xxx; ELEM_PER_PART=100; DOF_PER_PART=1400  ;;
    esac
    ;;
  esac
  #
