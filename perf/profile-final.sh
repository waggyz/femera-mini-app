...
for P in $PLIST; do
  ...
  1)
    ...
    6148b)   MINPART=40;  MINSIZE_MD=480819; ELEM_PER_PART=20000; DOF_PER_PART=10000; ;;
    E5-2640) ;;
    E5-2650) ;;
    E5-2670) ;;
    esac
  ...
  2)
    ...
    case $CPUMODEL in
    6148)    MINPART=240; MINSIZE_MD=679635; ELEM_PER_PART=1000; DOF_PER_PART=4000; ;;
    6148b)   MINPART=320; MINSIZE_MD=679635; ELEM_PER_PART=1000; DOF_PER_PART=4000; ;;
    E5-2640) ;;
    E5-2650) ;;
