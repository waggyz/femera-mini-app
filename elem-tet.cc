...
const RESTRICT Mesh::vals Tet::GaussLegendre(const INT_ORDER p ){
  ...
  //case(0) :
  case(1):{ this->gaus_n= 1;// this->gaus_weig.resize(gaus_n);
    //this->gaus_weig={1.0};
    return Mesh::vals{ 0.25,0.25,0.25, 1.0/6.0 };//FIXME weight?
    break;}
  case(2):{ this->gaus_n= 4;// this->gaus_weig={0.25,0.25,0.25,0.25};
  ...
  case(3):{ this->gaus_n= 5;// this->gaus_weig.resize(gaus_n);
    //this->gaus_weig={-24./30.,54./120.,54./120.,54./120.,54./120.};
    return Mesh::vals{
    0.25 , 0.25 , 0.25 ,-4./ 30.,
    0.5  , 1./6., 1./6., 9./120.,
    1./6., 0.5  , 1./6., 9./120.,
  ...
  case(4):{ this->gaus_n=11;// this->gaus_weig.resize(gaus_n);
    //this->gaus_weig={-74*6./5625.,
    //  343.*6./45000.,343.*6./45000.,343.*6./45000.,343.*6./45000.,56.*6./2250.,
    //  56.*6./2250.,56.*6./2250.,56.*6./2250.,56.*6./2250.,56.*6./2250. };
...
const RESTRICT Mesh::vals Tet::ShapeFunction(
  ...
  case(3):{ RESTRICT Mesh::vals f(20);
    ...
    //
    f[ 8]=4.5*( L1*L3 *(3.*L1 -1.) );
    f[ 9]=4.5*( L1*L3 *(3.*L3 -1.) );
    //
    f[10]=4.5*( L1*L4 *(3.*L1 -1.) );
    f[11]=4.5*( L1*L4 *(3.*L4 -1.) );
    //
    f[12]=4.5*( L3*L4 *(3.*L3 -1.) );
    f[13]=4.5*( L3*L4 *(3.*L4 -1.) );
    //
    f[14]=4.5*( L2*L4 *(3.*L2 -1.) );
    f[15]=4.5*( L2*L4 *(3.*L4 -1.) );
...
const RESTRICT Mesh::vals Tet::ShapeGradient(
  ...
  case(3):{ v=1.0;
    ...
    //
    g[ 6]=4.5*( L1r*L3 *(3.*L1 -1.) + L1 *L3r*(3.*L1 -1.) + L1 *L3 *(3.*L1r) );
    g[ 7]=4.5*( L1r*L3 *(3.*L3 -1.) + L1 *L3r*(3.*L3 -1.) + L1 *L3 *(3.*L3r) );
    //
    g[ 8]=4.5*( L1r*L4 *(3.*L1 -1.) + L1 *L4r*(3.*L1 -1.) + L1 *L4 *(3.*L1r) );
    g[ 9]=4.5*( L1r*L4 *(3.*L4 -1.) + L1 *L4r*(3.*L4 -1.) + L1 *L4 *(3.*L4r) );
    //
    g[10]=4.5*( L2r*L3 *(3.*L2 -1.) + L2 *L3r*(3.*L2 -1.) + L2 *L3 *(3.*L2r) );
    g[11]=4.5*( L2r*L3 *(3.*L3 -1.) + L2 *L3r*(3.*L3 -1.) + L2 *L3 *(3.*L3r) );
    //
    g[12]=4.5*( L2r*L4 *(3.*L2 -1.) + L2 *L4r*(3.*L2 -1.) + L2 *L4 *(3.*L2r) );
    g[13]=4.5*( L2r*L4 *(3.*L4 -1.) + L2 *L4r*(3.*L4 -1.) + L2 *L4 *(3.*L4r) );
    //
    g[14]=4.5*( L3r*L4 *(3.*L3 -1.) + L3 *L4r*(3.*L3 -1.) + L3 *L4 *(3.*L3r) );
    g[15]=4.5*( L3r*L4 *(3.*L4 -1.) + L3 *L4r*(3.*L4 -1.) + L3 *L4 *(3.*L4r) );
    // face nodes 0,1,2, 0,1,3, 0,3,2, 1,2,3 
    ...
    //
    g[26]=4.5*( L1s*L3 *(3.*L1 -1.) + L1 *L3s*(3.*L1 -1.) + L1 *L3 *(3.*L1s) );
    g[27]=4.5*( L1s*L3 *(3.*L3 -1.) + L1 *L3s*(3.*L3 -1.) + L1 *L3 *(3.*L3s) );
    //
    g[28]=4.5*( L1s*L4 *(3.*L1 -1.) + L1 *L4s*(3.*L1 -1.) + L1 *L4 *(3.*L1s) );
    g[29]=4.5*( L1s*L4 *(3.*L4 -1.) + L1 *L4s*(3.*L4 -1.) + L1 *L4 *(3.*L4s) );
    //
    g[30]=4.5*( L2s*L3 *(3.*L2 -1.) + L2 *L3s*(3.*L2 -1.) + L2 *L3 *(3.*L2s) );
    g[31]=4.5*( L2s*L3 *(3.*L3 -1.) + L2 *L3s*(3.*L3 -1.) + L2 *L3 *(3.*L3s) );
    //
    g[32]=4.5*( L2s*L4 *(3.*L2 -1.) + L2 *L4s*(3.*L2 -1.) + L2 *L4 *(3.*L2s) );
    g[33]=4.5*( L2s*L4 *(3.*L4 -1.) + L2 *L4s*(3.*L4 -1.) + L2 *L4 *(3.*L4s) );
    //
    g[34]=4.5*( L3s*L4 *(3.*L3 -1.) + L3 *L4s*(3.*L3 -1.) + L3 *L4 *(3.*L3s) );
    g[35]=4.5*( L3s*L4 *(3.*L4 -1.) + L3 *L4s*(3.*L4 -1.) + L3 *L4 *(3.*L4s) );
    // face nodes 0,1,2, 0,1,3, 0,3,2, 1,2,3 
    ...
    //
    g[46]=4.5*( L1t*L3 *(3.*L1 -1.) + L1 *L3t*(3.*L1 -1.) + L1 *L3 *(3.*L1t) );
    g[47]=4.5*( L1t*L3 *(3.*L3 -1.) + L1 *L3t*(3.*L3 -1.) + L1 *L3 *(3.*L3t) );
    //
    g[48]=4.5*( L1t*L4 *(3.*L1 -1.) + L1 *L4t*(3.*L1 -1.) + L1 *L4 *(3.*L1t) );
    g[49]=4.5*( L1t*L4 *(3.*L4 -1.) + L1 *L4t*(3.*L4 -1.) + L1 *L4 *(3.*L4t) );
    //
    g[50]=4.5*( L2t*L3 *(3.*L2 -1.) + L2 *L3t*(3.*L2 -1.) + L2 *L3 *(3.*L2t) );
    g[51]=4.5*( L2t*L3 *(3.*L3 -1.) + L2 *L3t*(3.*L3 -1.) + L2 *L3 *(3.*L3t) );
    //
    g[52]=4.5*( L2t*L4 *(3.*L2 -1.) + L2 *L4t*(3.*L2 -1.) + L2 *L4 *(3.*L2t) );
    g[53]=4.5*( L2t*L4 *(3.*L4 -1.) + L2 *L4t*(3.*L4 -1.) + L2 *L4 *(3.*L4t) );
    //
    g[54]=4.5*( L3t*L4 *(3.*L3 -1.) + L3 *L4t*(3.*L3 -1.) + L3 *L4 *(3.*L3t) );
    g[55]=4.5*( L3t*L4 *(3.*L4 -1.) + L3 *L4t*(3.*L4 -1.) + L3 *L4 *(3.*L4t) );
    // face nodes 0,1,2, 0,1,3, 0,3,2, 1,2,3 
