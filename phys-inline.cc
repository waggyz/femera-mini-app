...
static inline void test_g_h( FLOAT_PHYS* G, __m256d* vH,// line 273
  ...
  if(Nc==10){
    ...
    const __m256d L0=_mm256_set_pd(0.0,-1.0,-1.0,-1.0 );// j0 = [j3 j2 j1 j0]
    const __m256d L1=_mm256_set_pd(0.0, 0.0, 0.0, 1.0 );// j1 = [j6 j5 j4 j3]
    const __m256d L2=_mm256_set_pd(0.0, 0.0, 1.0, 0.0 );// j2 = [j9 j8 j7 j6]
    ...
    */
    ...
    __m256d vg
      ...
      + vJ[2] *_mm256_set1_pd( sg[2]);{ const int i=0;
    ...
    vg= vJ[0] *_mm256_set1_pd( sg[0])
      + vJ[1] *_mm256_set1_pd( sg[1])
      + vJ[2] *_mm256_set1_pd( sg[2]);{ const int i=1;
    vH[0]+= vg *_mm256_set1_pd( u[3* i+0 ]);
    vH[1]+= vg *_mm256_set1_pd( u[3* i+1 ]);
    vH[2]+= vg *_mm256_set1_pd( u[3* i+2 ]);
    _mm256_store_pd(& G[4* i ], vg ); }
    ...
    vg= vJ[0] *_mm256_set1_pd( sg[0])
      + vJ[1] *_mm256_set1_pd( sg[1])
      + vJ[2] *_mm256_set1_pd( sg[2]);{ const int i=2;
    vH[0]+= vg *_mm256_set1_pd( u[3* i+0 ]);
    vH[1]+= vg *_mm256_set1_pd( u[3* i+1 ]);
    vH[2]+= vg *_mm256_set1_pd( u[3* i+2 ]);
    _mm256_store_pd(& G[4* i ], vg ); }
    ...
    vg= vJ[0] *_mm256_set1_pd( sg[0])
      + vJ[1] *_mm256_set1_pd( sg[1])
      + vJ[2] *_mm256_set1_pd( sg[2]);{ const int i=3;
    vH[0]+= vg *_mm256_set1_pd( u[3* i+0 ]);
    vH[1]+= vg *_mm256_set1_pd( u[3* i+1 ]);
    vH[2]+= vg *_mm256_set1_pd( u[3* i+2 ]);
    _mm256_store_pd(& G[4* i ], vg ); }
    ...
    */
    ...
    vg= vJ[0] *_mm256_set1_pd( sg[0])
      + vJ[1] *_mm256_set1_pd( sg[1])
      + vJ[2] *_mm256_set1_pd( sg[2]);{ const int i=4;
    vH[0]+= vg *_mm256_set1_pd( u[3* i+0 ]);
    vH[1]+= vg *_mm256_set1_pd( u[3* i+1 ]);
    vH[2]+= vg *_mm256_set1_pd( u[3* i+2 ]);
    _mm256_store_pd(& G[4* i ], vg ); }
    ...
    vg= vJ[0] *_mm256_set1_pd( sg[0])
      + vJ[1] *_mm256_set1_pd( sg[1])
      + vJ[2] *_mm256_set1_pd( sg[2]);{ const int i=5;
    vH[0]+= vg *_mm256_set1_pd( u[3* i+0 ]);
    vH[1]+= vg *_mm256_set1_pd( u[3* i+1 ]);
    vH[2]+= vg *_mm256_set1_pd( u[3* i+2 ]);
    _mm256_store_pd(& G[4* i ], vg ); }
    ...
    vg= vJ[0] *_mm256_set1_pd( sg[0])
      + vJ[1] *_mm256_set1_pd( sg[1])
      + vJ[2] *_mm256_set1_pd( sg[2]);{ const int i=6;
    vH[0]+= vg *_mm256_set1_pd( u[3* i+0 ]);
    vH[1]+= vg *_mm256_set1_pd( u[3* i+1 ]);
    vH[2]+= vg *_mm256_set1_pd( u[3* i+2 ]);
    _mm256_store_pd(& G[4* i ], vg ); }
    ...
    vg= vJ[0] *_mm256_set1_pd( sg[0])
      + vJ[1] *_mm256_set1_pd( sg[1])
      + vJ[2] *_mm256_set1_pd( sg[2]);{ const int i=7;
    vH[0]+= vg *_mm256_set1_pd( u[3* i+0 ]);
    vH[1]+= vg *_mm256_set1_pd( u[3* i+1 ]);
    vH[2]+= vg *_mm256_set1_pd( u[3* i+2 ]);
    _mm256_store_pd(& G[4* i ], vg ); }
    ...
    vg= vJ[0] *_mm256_set1_pd( sg[0])
      + vJ[1] *_mm256_set1_pd( sg[1])
      + vJ[2] *_mm256_set1_pd( sg[2]);{ const int i=8;
    vH[0]+= vg *_mm256_set1_pd( u[3* i+0 ]);
    vH[1]+= vg *_mm256_set1_pd( u[3* i+1 ]);
    vH[2]+= vg *_mm256_set1_pd( u[3* i+2 ]);
    _mm256_store_pd(& G[4* i ], vg ); }
    ...
    vg= vJ[0] *_mm256_set1_pd( sg[0])
      + vJ[1] *_mm256_set1_pd( sg[1])
      + vJ[2] *_mm256_set1_pd( sg[2]);{ const int i=9;
    vH[0]+= vg *_mm256_set1_pd( u[3* i+0 ]);
    vH[1]+= vg *_mm256_set1_pd( u[3* i+1 ]);
    vH[2]+= vg *_mm256_set1_pd( u[3* i+2 ]);
    _mm256_store_pd(& G[4* i ], vg ); }
