...
int NCG::BC (Mesh* ){return 0;};
int NCG::RHS(Mesh* ){return 0;};
//
int NCG::RHS(Elem* E, Phys* Y ){
...
int NCG::Iter(){// 2 FLOP + 12 FLOP/DOF, 14 float/DOF
...
int NCG::Solve( Elem* E, Phys* Y ){//FIXME Redo this
  //this->Setup( E,Y );
  this->Init( E,Y );
  if( !this->Init() ){//============ Solve ================
...
int HaloNCG::Init(){// Preconditioned Conjugate Gradient
#ifdef _OPENMP
